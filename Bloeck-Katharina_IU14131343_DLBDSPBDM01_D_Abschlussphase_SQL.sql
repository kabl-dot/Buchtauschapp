...
--SELECT b.title, b.isbn, c.condition, u.first_name, u.last_name 
...
--SELECT user.user_id, user.first_name, user.last_name, role.role_name
--FROM user 
--JOIN userRole 
...
--SELECT  u.last_name AS borrower, b.title, t.status, DATE(t.requested_at) AS requested_at, DATE(t.due_at) AS due_at, DATE(t.returned_at) AS returned_at
--FROM transactions t
--JOIN user u 
--	ON t.borrower_user_id = u.userid
--JOIN offer o 
...
--CREATE INDEX idx_copy_owner_user_id ON copy(owner_user_id);
--CREATE INDEX idx_offer_copy_id ON offer(copy_id);
--CREATE INDEX idx_transactions_offer_id ON transactions(offer_id);
--CREATE INDEX idx_transactions_borrower_user_id ON transactions(borrower_user_id);
--CREATE INDEX idx_review_book_id ON review(book_id);
--CREATE INDEX idx_bookgenre_genre_id ON bookGenre(genre_id);
--CREATE INDEX idx_bookauthor_author_id ON bookAuthor(author_id);

-- Abfragen von Metadaten
--SELECT  Count(*) FROM sqlite_master WHERE type='table';

/*
SELECT 'user' AS table_name, COUNT(*) AS entries FROM user
UNION ALL
...
UNION ALL
SELECT 'bookAuthor', COUNT(*) FROM bookAuthor
UNION ALL
SELECT 'bookGenre', COUNT(*) FROM bookGenre
UNION ALL
SELECT 'copy', COUNT(*) FROM copy
UNION ALL
